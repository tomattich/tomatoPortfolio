...
export function footer() {
    ...
    <div class="footerSocials">
        <button class="buttons discordButton" aria-label="Discord">
        ...
        <button class="buttons githubButton" aria-label="GitHub">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" class="social-icon">
        ...
        <button class="buttons telegramButton" aria-label="Telegram">
                 <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" class="social-icon">
    ...
    <div class="footerCopyright">
        <p>Copyright © 2026 Tomato. All rights reserved.</p>
        <p class="madeBy">designed & developed by Tomato</p>
    </div>
    `;
