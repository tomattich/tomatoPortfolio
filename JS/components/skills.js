    ...
    summary.innerHTML = `
        <div class="skills">
            ...
            <div>
                ...
                UI/UX Design</p>
                <p class="skillsDetails">Create a unique visual identity for your business with impactful and memorable visuals.</p>
            </div>
            <ul>
                <li></li>
            </ul>
            <div>
                ...
                <p class="skillsDetails">I have experience in building mobile apps using React Native and Flutter. I have also worked on several projects using React Native and Flutter.</p>
            </div>
        </div>
        <div class="aboutMe">
            <h1>About me</h1>
            <p>I started my journey as a frontend developer in 2022 and I have been passionate about it ever since. I have a strong foundation in HTML, CSS, and JavaScript, and I am always eager to learn new technologies and techniques.</p>
